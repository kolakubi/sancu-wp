...
<header id="site-header" style="position: fixed!important;margin-top: 0px;box-shadow: 10px 10px 26px -10px rgba(0,0,0,0.1);" class="<?php echo esc_attr( oceanwp_header_classes() ); ?>" data-height="<?php echo esc_attr( $header_height ); ?>"<?php oceanwp_schema_markup( 'header' ); ?>>
